...
bool gareafile::ReadAreafile(word crc, char* parameters)
{
    ...
    case CRC_AREAS_BBS:
    case CRC_AREASBBS:
        ReadAreasBBS(parameters);
        break;
#if !defined(GCFG_NOCMAIL) || !defined(GCFG_NOCECHO)
    case CRC_CRASHECHO:
    case CRC_CRASHMAIL:
        ReadCrashmail(parameters);
        break;
#endif
#ifndef GCFG_NOEZY
    case CRC_EZYCOM:
        ReadEzycom(parameters);
        break;
#endif
#ifndef GCFG_NOFE
    case CRC_FE_ABS:
    case CRC_FASTECHO:
        ReadFastecho(parameters);
        break;
#endif
...
#ifndef GCFG_NOFD
    case CRC_FRONTDOOR:
        ReadFrontDoor(parameters);
        break;
#endif
#ifndef GCFG_NOGECHO
    case CRC_GECHO:
        ReadGEcho(parameters);
        break;
#endif
#ifndef GCFG_NOLORA
    case CRC_LORABBS:
        ReadLoraBBS(parameters);
        break;
#endif
#ifndef GCFG_NOMAXIMUS
    case CRC_MAXIMUS:
        ReadMaximus(parameters);
        break;
#endif
#ifndef GCFG_NOME2
    case CRC_ME2:
...
#ifndef GCFG_NOQECHO
    case CRC_QECHO:
        ReadQEcho(parameters);
        break;
#endif
#ifndef GCFG_NOQFRONT
    case CRC_QFRONT:
        ReadQFront(parameters);
        break;
#endif
    ...
    case CRC_PARTOSS:
    case CRC_SQUISH:
        ReadSquish(parameters);
        break;
#endif
#ifndef GCFG_NOSPCT
    case CRC_SPACETOSS:
        ReadSpaceToss(parameters);
        break;
#endif
#ifndef GCFG_NOTERMAIL
    case CRC_TMAIL:
    case CRC_TERMAIL:
        ReadTmail(parameters);
        break;
#endif
#ifndef GCFG_NOSYNCHRONET
    case CRC_SBBS:
        ReadSynchronet(parameters);
        break;
#endif
    default:
        return false;
