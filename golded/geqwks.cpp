        ...
        do
        {
            ...
            if(more)
            {
                ...
                if(tosstobadmsgs != -1)
                {
                    ...
                    // Read message text
                    char* txtptr = msg->txt = (char*)calloc(1, msglen+128);
                    if(tosstobadmsgs)
                    {
                    ...
                    if(msg->messageid or msg->references or msg->inreplyto or *msg->ifrom)
                    {
                        ...
                        if(*msg->ifrom)
                        {
                            ...
                            if (AA->Internetgate().addr.valid())
                            {
                                ...
                                msg->txt = (char*)realloc(msg->txt, txtlen+addlen+1);
...
void Qwk::AddBBS(char* bbsid)
{
    ...
    bbs = (QwkBbs*)realloc(bbs, (bbss+1)*sizeof(QwkBbs));
    bbsp = bbs + bbss++;
...
void Qwk::AddMap(char* bbsid, char* echoid, char* confname, int confno)
{
    ...
    FindAddBBS(bbsid);
    bbsp->map = (QwkMap*)realloc(bbsp->map, (bbsp->maps+1)*sizeof(QwkMap));
