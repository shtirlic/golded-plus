...
#define __GVER_VENDOR_NAME__ "Serg Podtynnyi"
#undef __GVER_VENDOR_FIDO__
#define __GVER_VENDOR_FIDO__  "2:5030/3165"
#undef __GVER_VENDOR_EMAIL__
#define __GVER_VENDOR_EMAIL__ "serg@podtynnyi.com"
