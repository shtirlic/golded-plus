            ...
            if(inhdr)
            {
                ...
                else
                {
                    ...
                    *lbuf = CTRL_A;
                    ...
                    {
                        char* ccbuf = (char*)malloc(strlen(msg->icc) + strlen(mptr) + 3);
                    ...
                    {
                        char* bccbuf = (char*)malloc(strlen(msg->ibcc) + strlen(mptr) + 3);
...
int ImportSOUP()
{
    ...
    if(*CFG->soupimportpath)
    {
        ...
        if (fpa.isopen())
        {
            ...
            char* mbuf = (char*)malloc(MBUF_SIZE);
            char* lbuf = (char*)malloc(LBUF_SIZE);
                    ...
                    if (fpm.isopen())
                    {
                        ...
                        if((msgfmt == 'b') or (msgfmt == 'B'))
                        {
                            ...
                            while (fpm.Fread(&msglen, 4) == 1)
                            {
                                ...
                                if(msglen != msglensz)
                                    msglensz--;
                                msg->txt = (char*)calloc(1, msglensz+1);
                            ...
                            while (fpm.Fgets(mbuf, MBUF_SIZE))
                            {
                                ...
                                else if(msgfmt == 'm')
                                {
                                    ...
                                    if((txtlen+len+1) > allocated_len)
                                    {
                                        ...
                                        txtptr = (char*)realloc(txtptr, allocated_len);
                                    }
