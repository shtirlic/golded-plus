    ...
    if(AA->LoadMsg(msg, AA->Msgn.CvtReln(AA->lastread()), margin))
    {
        ...
        if(msg->msgno and not AA->attr().hex())
        {
            ...
            if(reader_msglistfirst == false)
            {
                ...
                if(reader_rcv_noise > 1)
                {
                    GMsg* tmsg = (GMsg*) calloc(1, sizeof(GMsg));
...
void GotoReplies()
{
    ...
    GMsg* rmsg = (GMsg*)calloc(1, sizeof(GMsg));
    ReplySel* rlist = (ReplySel*)calloc(list_max+3, sizeof(ReplySel));
...
void GotoReplyNext()
{
    ...
    {
        GMsg* tempmsg = (GMsg*)calloc(1, sizeof(GMsg));
